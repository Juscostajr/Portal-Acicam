 ...
 * @copyright 2007-2011
  ...
  **/
	...
	abstract class WideImage_Image
	{
		...
		function fitIn($lim_largura,$lim_altura)
		{
			...
			if($altura >= $largura){
				if($altura > $lim_altura){
					$nova_largura = ($largura*$lim_altura)/$largura;
					$nova_altura = $lim_altura;
				}
				else{
				...
				if($largura > $lim_largura){
					$nova_altura = ($altura*$lim_largura)/$largura;
					$nova_largura = $lim_largura;
				}
				else{
					$nova_largura = $largura;
					$nova_altura = $altura;
			...
			return  $this->resize($nova_largura, $nova_altura);
		}
		/**
