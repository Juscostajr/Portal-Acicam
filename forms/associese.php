...
if (isset($_POST['associese']))
{
    ...
    $destino = "comercial@acicam.com.br";
...
<div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Associe-se</h4>
            </div>
 <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
     ...
     <div class="form-group ">
      ...
      <input class="form-control" id="endereco" name="endereco" placeholder="Endereço da Empresa" type="text">
     </div>
     <div class="form-group ">
